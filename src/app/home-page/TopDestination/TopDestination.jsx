      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-3 lg:gap-6">
        <div className="relative group items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center transition-transform duration-300 ease-out translate-y-[45%] group-hover:translate-y-[1%]">
            <h1 className="text-2xl font-semibold text-white tracking-wide">Nevada</h1>
            <button className="text-sm font-medium uppercase text-my-secondary mt-3">
              view all tours
            </button>
          </div>
        </div>
        <div className="relative group items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/40 group-hover:from-black/60 group-hover:via-black/50 group-hover:to-black/60"></div>
          <div className="absolute inset-0 flex flex-col items-center justify-center transition-transform duration-300 ease-out translate-y-[45%] group-hover:translate-y-[1%]">
            <h1 className="text-2xl font-semibold text-white tracking-wide">Los Angeles</h1>
            <button className="text-sm font-medium uppercase text-my-secondary mt-3">
              view all tours
            </button>
          </div>
        ...
        <div className="relative group items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/40 group-hover:from-black/60 group-hover:via-black/50 group-hover:to-black/60"></div>
          <div className="absolute inset-0 flex flex-col items-center justify-center transition-transform duration-300 ease-out translate-y-[45%] group-hover:translate-y-[1%]">
            <h1 className="text-2xl font-semibold text-white tracking-wide">California</h1>
            <button className="text-sm font-medium uppercase text-my-secondary mt-3">
              view all tours
            </button>
          </div>
        ...
        <div className="relative group items-center justify-center overflow-hidden">
          <Image className="object-cover" src={San_francisco} alt="San_francisco" />
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/40 group-hover:from-black/60 group-hover:via-black/50 group-hover:to-black/60"></div>
          <div className="absolute inset-0 flex flex-col items-center justify-center transition-transform duration-300 ease-out translate-y-[45%] group-hover:translate-y-[1%]">
            <h1 className="text-2xl font-semibold text-white tracking-wide">San Francisco</h1>
            <button className="text-sm font-medium uppercase text-my-secondary mt-3">
              view all tours
            </button>
          </div>
        ...
        <div className="relative group items-center justify-center overflow-hidden">
          <Image className="object-cover" src={United_states} alt="United_states" />
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/40 group-hover:from-black/60 group-hover:via-black/50 group-hover:to-black/60"></div>
          <div className="absolute inset-0 flex flex-col items-center justify-center transition-transform duration-300 ease-out translate-y-[45%] group-hover:translate-y-[1%]">
            <h1 className="text-2xl font-semibold text-white tracking-wide">United States</h1>
            <button className="text-sm font-medium uppercase text-my-secondary mt-3">
              view all tours
            </button>
          </div>
        ...
        <div className="relative group items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/40 group-hover:from-black/60 group-hover:via-black/50 group-hover:to-black/60"></div>
          <div className="absolute inset-0 flex flex-col items-center justify-center transition-transform duration-300 ease-out translate-y-[45%] group-hover:translate-y-[1%]">
            <h1 className="text-2xl font-semibold text-white tracking-wide">Virginia</h1>
            <button className="text-sm font-medium uppercase text-my-secondary mt-3">
              view all tours
            </button>
          </div>
